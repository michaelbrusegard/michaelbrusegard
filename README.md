...
- **[Manafish UI](https://github.com/manafishrov/ui)**  
...
- **[Lektr](https://github.com/michaelbrusegard/lektr)**  
  A web application with an advanced text editor built with Web Sockets. It is currently WIP. It is built to be a tool for students to collaborate and share resources for courses at university.
...
- **[Advent of Code 2025](https://github.com/michaelbrusegard/advent-of-code-2025)**  
  My solutions to the Advent of Code 2025 problems in C.
...
A more accurate representation of my most used languages would probably be: TypeScript, Python, Rust, Kotlin and Nix.
